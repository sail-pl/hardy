...
// LOGIC
%token AS EXISTS_PREV FORALL_PREV FORALL_INST FORALL EXISTS EXISTS_INST ARROW DARROW AND OR TRUE FALSE
%token EOF
...
%token EVENTUALLY ALWAYS NEXT UNTIL WEAK_UNTIL RELEASE SRELEASE
%token SINCE WEAK_SINCE
...
%left PLUS MINUS
%left TIMES DIVIDE
%right UNTIL WEAK_UNTIL SRELEASE RELEASE
%right SINCE WEAK_SINCE
